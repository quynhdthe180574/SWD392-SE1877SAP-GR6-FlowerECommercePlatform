            ...
            <div class="col-auto">
                <a href="${pageContext.request.contextPath}/view-cart" class="cart-link">
                    <div class="d-flex align-items-center">
                        ...
                        <span class="fs-5 fw-medium">Giỏ hàng</span>
    ...
    <c:choose>
                        ...
                        <div class="product-card h-100">
                            ...
                            <div class="product-info">
                                ...
                                <button class="btn-add w-100 d-flex align-items-center justify-content-center"
                                    ...
                                    <c:choose>
                                        <c:when test="${p.stockQuantity == 0}">Hết hàng</c:when>
        ...
        <c:otherwise>
            <div class="empty-state">
                ...
                <p class="text-muted">Hãy quay lại sau hoặc liên hệ cửa hàng để cập nhật danh sách hoa tươi.</p>
