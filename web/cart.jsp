...
<body>
    ...
    <div class="header">
        ...
        <p>Chọn những bông hoa đẹp nhất cho người bạn yêu thương</p>
    </div>
    ...
    <div class="container" id="cartContainer">
        ...
        <div class="cart-header">
            ...
            <div class="item-count"><%= cart.size() %> sản phẩm</div>
        </div>
        ...
        <div class="summary">
            ...
            <p><span>Tổng tiền hàng:</span> <strong>$<%= String.format("%.2f", total) %></strong></p>
            <p><span>Phí vận chuyển:</span> <strong>30,000 VND</strong></p>
            <p class="total">$<%= String.format("%.2f", total + 30000) %></p>
            <button class="checkout-btn" onclick="window.location.href='checkout.jsp'">Thanh toán ngay</button>
        </div>
        <% } %>
    </div>
